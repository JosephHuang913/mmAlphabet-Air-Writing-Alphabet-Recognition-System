...
class Console(Cmd):
    ...
    def __processing_thread(self):
        ...
        while True:
            ...
            Range_Spec[-1,:,:] = np.sum(np.abs(radar_cube_clutter_removed), axis=1)  # (num_frames, num_chirps, range bins) = (60, 32, 32)
            ...
            with self.predicting_lock:
                if self.predicting:
                    ...
                    #if frame_num == round(self.configs.frame_rate):    # recognize gesture every second
